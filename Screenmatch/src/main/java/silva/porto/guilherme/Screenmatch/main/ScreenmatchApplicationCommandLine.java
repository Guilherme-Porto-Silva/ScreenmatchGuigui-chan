...
@SpringBootApplication  public class ScreenmatchApplicationCommandLine implements CommandLineRunner {
    ...
    public static void previousMain(String[] args) {
        ...
        while (true) {
            ...
            try{ SpringApplication.run(ScreenmatchApplicationCommandLine.class, args); }
